...
<h2>
 ...
 %><br><br>
								...
								&nbsp;&nbsp;&nbsp; 
								<a href="<%=request.getContextPath() + URLConstantAdmin.UPDATEDISH%>?DishId=<%=d.getDishId()%>">
								<i class="fa-solid fa-pen-to-square" style="font-size: 24px; color: black; text-align: right"></i>
								</a>&nbsp;
								<a href="<%=request.getContextPath() + URLConstantAdmin.DELETEDISH%>?DishId=<%=d.getDishId()%>" align="right"> 
								<i class="fas fa-trash-alt" style="font-size: 24px; color: black; align: right;"></i>
								</a>&nbsp;&nbsp;
								<a type="button" class="btn btn-warning" href="<%=request.getContextPath() + URLConstantAdmin.VIEWDISH%>?DishId=<%=d.getDishId()%>">
									Order </a>
							</div>
