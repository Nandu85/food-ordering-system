...
<div class="container-scroller">
	...
	<header class="jumbotron" align="center">
		<h2>
			<strong> Our Popular Dishes </strong>
		</h2>
	</header>
	<div class="container">
		<div class="row">
			<form action="<%=request.getContextPath() + URLConstantAdmin.SEARCHDISH%>"
				method="GET">
		...
		<br> <br> Haven't find your favorite, <a
			href="<%=request.getContextPath() + URLConstantAdmin.ADDDISH%>"> Add
			it here... </a> <br> <br>
		<div class="row">
			...
			int count = 0;
				...
				al = (ArrayList) request.getAttribute("dataList");
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<img src="data:image/png;base64,<%=d.getPhotoAsBase64()%>"
							...
							<div align="right">
								<a
								href="<%=request.getContextPath() + URLConstantAdmin.UPDATEDISH%>?DishId=<%=d.getDishId()%>">
								<i class="fa-solid fa-pen-to-square"
								style="font-size: 24px; color: black; text-align: right"></i>
								</a>&nbsp; <a
								href="<%=request.getContextPath() + URLConstantAdmin.DELETEDISH%>?DishId=<%=d.getDishId()%>"
								align="right"> <i class="fas fa-trash-alt"
								style="font-size: 24px; color: black; text-align: right"></i></a>&nbsp;&nbsp;&nbsp;
							</div>
							
							<a type="button" class="btn btn-warning"
								href="<%=request.getContextPath() + URLConstantAdmin.VIEWDISH%>?DishId=<%=d.getDishId()%>">
								Order </a>
